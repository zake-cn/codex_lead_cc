...
export async function loadConfig(projectPath) {
    ...
    for (const configPath of configPaths) {
        ...
        merged = {
            max_concurrent_workers: parsed.max_concurrent_workers ?? merged.max_concurrent_workers,
            runtime: {
                ...merged.runtime,
                ...(parsed.runtime ?? {}),
            },
            worker_idle_timeout_sec: parsed.worker_idle_timeout_sec ?? merged.worker_idle_timeout_sec,

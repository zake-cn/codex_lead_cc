...
export function buildTaskReport(args) {
    ...
    const durationMs = args.result?.durationMs ??
...
export function summarizeTaskReport(status, stdout, stderr) {
    if (status === "pending") {
...
function roleSpecificFields(task, stdout, stderr, exitCode) {
    if (task.role === "tester") {
        return {
            commands_run: [
                {
...
function inferReviewDecision(stdout) {
...
//# sourceMappingURL=build_report.js.map
...
function normalizePlanTasks(planId, specs, startIndex) {
...
function snapshotPlan(plan, reason) {
    return {
        version: plan.version,
        status: plan.status,
        goal: plan.goal,
...
function nextPlanTaskIndex(tasks) {
...
//# sourceMappingURL=plan_manager.js.map
...
const FAILED_DEPENDENCY_STATUSES = new Set([
    "failed",
    "timeout",
    "stopped",
    "skipped",
...
function canTransitionTask(status) {
    return status === "pending" || status === "blocked" || status === "ready";
}
function transitionTask(state, task, nextStatus, blockedBy, summary) {
...
//# sourceMappingURL=dag_scheduler.js.map
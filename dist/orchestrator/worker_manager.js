...
const VALID_ROLES = new Set(WORKER_ROLES);
const VALID_RUNTIMES = new Set(WORKER_RUNTIMES);
    ...
    async createWorker(input) {
        ...
        return this.store.updateState((state) => {
            ...
            state.sessions[sessionId] = {
                ...
                metadata: {
                    adapter_note: runtime === "claude_sdk"
...
//# sourceMappingURL=worker_manager.js.map
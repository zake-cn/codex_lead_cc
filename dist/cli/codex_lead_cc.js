...
function buildCodexLaunch(options, supervisorInstruction, userConfig, projectContext) {
    const notes = [
...
function buildConfigToml(options, userConfig, projectContext, exposure) {
    if (options.mode === "off") {
...
function readinessChecks(userConfig) {

...
export function detectInstallSource(repoRoot) {
...
export function runUpdate(options, repoRoot) {
...
function printUpdatePlan(installSource, commands, dryRun) {
...
function printManualUpdateHelp(source) {

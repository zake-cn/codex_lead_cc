export declare const WORKER_ROLES: readonly ["scout", "implementer", "tester", "reviewer"];
export type WorkerRole = (typeof WORKER_ROLES)[number];
export declare const WORKER_RUNTIMES: readonly ["claude_cli", "claude_sdk"];
export type WorkerRuntime = (typeof WORKER_RUNTIMES)[number];
export declare const WORKER_STATUSES: readonly ["idle", "pending", "running", "busy", "stopped", "crashed"];
export type WorkerStatus = (typeof WORKER_STATUSES)[number];
export declare const WORKER_HEALTH_STATUSES: readonly ["healthy", "idle", "busy", "idle_timeout", "stopped", "crashed"];
export type WorkerHealthStatus = (typeof WORKER_HEALTH_STATUSES)[number];
export declare const TASK_STATUSES: readonly ["pending", "blocked", "ready", "waiting_permission", "running", "completed", "failed", "timeout", "stopped", "skipped"];
...
export declare const SUPERVISOR_STATES: readonly ["active", "planning", "dispatching", "waiting", "sleeping", "reviewing", "blocked", "completed"];
export type SupervisorStateValue = (typeof SUPERVISOR_STATES)[number];
export declare const WAKE_PRIORITIES: readonly ["low", "medium", "high", "critical"];
export type WakePriority = (typeof WAKE_PRIORITIES)[number];
export declare const REPORT_LEVELS: readonly ["summary", "full", "raw"];
...
export type EventType = "worker_created" | "worker_deleted" | "worker_stopped" | "worker_restarted" | "worker_stalled" | "worker_crashed" | "worker_health_checked" | "idle_workers_cleaned" | "task_created" | "task_queued" | "task_ready" | "task_blocked" | "task_skipped" | "dag_unblocked" | "task_started" | "task_completed" | "task_failed" | "task_timeout" | "task_stopped" | "permission_requested" | "permission_approved" | "permission_rejected" | "partial_report_ready" | "report_created" | "patch_created" | "patch_generated" | "test_completed" | "review_completed" | "all_tasks_completed" | "worktree_created" | "worktree_cleanup" | "worktree_fallback" | "plan_created" | "plan_updated" | "plan_completed" | "plan_task_linked" | "session_created" | "session_cleaned" | "metrics_collected" | "metrics_updated" | "worker_stdout_chunk" | "heartbeat" | "file_read" | "stage_changed" | "minor_progress" | "log_updated";
export type WakeEventType = EventType | "permission_requested" | "patch_generated" | "test_completed" | "review_completed" | "dag_unblocked";
